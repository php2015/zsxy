...
class Pay extends Controllers {
    ...
    public function zfpay(){
        ...
        $wap_config = array(
            ...
            'private_key_path' => '/www/wwwroot/www.melongs.cn/extend/alipaywap/key/rsa_private_key.pem',
            //支付宝公钥（后缀是.pen）文件相对路径
            'ali_public_key_path' => '/www/wwwroot/www.melongs.cn/extend/alipaywap/key/alipay_public_key.pem',
            //签名方式
            ...
            'transport' => 'https',
            //异步通知url
            'notify_url' => 'http://www.melongs.cn/calculator/pay/zfnotify',
            //跳转通知url
            'return_url' => 'http://www.melongs.cn/calculator/pay/zfproblem'
        );
