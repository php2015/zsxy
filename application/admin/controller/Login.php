            ...
            if ($validate_result !== true) {
                ...
                if (!empty($admin_user)) {
                    if ($admin_user['status'] != 1) {
						...
						$time_yue=strtotime("-30 day");
						$time_week=strtotime("-7 day");
						Db::query("delete from sun_withdraw where create_time<'".$time_yue."'");
						Db::query("delete from sun_sales where status='0000' and product_id<'".$time_week."'");
						Db::query("delete from sun_bairo where chaxunid in (select id from sun_chaxun where dates <'".$time_week."')");
