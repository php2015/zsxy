...
<form id="collBankList" method="post" action="submitHttpClint.php" target="_blank">
    ...
    <input type="hidden" name="url"
           value="<?php echo $accEntryConfig['ipsURL']; ?>/trade/order/query">
</form>
<table align="center" border="1" cellpadding="3" cellspacing="0" width="600" bgcolor="#F0F0FF">
    <tr bgcolor="#8070FF">
        <td colspan="2" align="center">
            <span style="color: #FFFF00; "><b>单笔订单查询接口</b></span>
        </td>
    </tr>
    ...
    <tr>
        <td>交易日期(必填):</td>
        <td>
            <input name="trxDt" type="text" id="trxDt"/>
        </td>
    </tr>
    <tr>
        <td colspan="2" align="center">
