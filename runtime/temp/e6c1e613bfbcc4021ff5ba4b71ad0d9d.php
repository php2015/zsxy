<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:31:"./themes/admin/staff/index.html";i:1571815579;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/staff/add'); ?>">添加员工</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form layui-form-pane" id="myform" action="<?php echo url('admin/staff/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        <td style="width: 12%;"><a href="<?php echo url('/admin/staffs/index',['keyword'=>$vo['names'],'date1'=>$date1,'date2'=>$date2,'type'=>1]); ?>" style="color:#4b9ffa" title="查询用户" ><?php echo $vo['names']; ?></a></td>
                        <td><?php echo $vo['mobile']; ?></td>
                        <td><?php echo $vo['sess'] + $vo['sesssb']; ?></td>
                        <td><?php echo $vo['sess']; ?></td>
                        <td><?php echo $vo['sesssb']; ?></td>
                        <td><?php echo $vo['sessdt'] + $vo['sessdtsb']; ?></td>
                      	<td><?php echo $vo['sessdt']; ?></td>
                      	<td><?php echo $vo['sessdtsb']; ?></td>
                        <td>
                            <a href="<?php echo url('admin/staff/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/staff/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
...
<script>
    ...
    function search(){
        $("#myform").attr('action',"<?php echo url('admin/staff/index'); ?>");
    }
</script>
