<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"./themes/admin/staffs/index.html";i:1571815579;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('admin/staffs/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['anames']; ?></td>
                        <td><?php echo $vo['mobile']; ?></td>
                        <td><?php echo $vo['idcard']; ?></td>
                        <td><?php echo $vo['names']; ?></td>
                        <td><?php if($vo['status'] > 0): ?> 已支付<?php else: ?>未支付<?php endif; ?></td>
                ...
                <div style="float:right; font-size:20px;"> 统计订单：<?php echo $zfsum + $wzfsum; ?> 成功订单：<?php echo $zfsum; ?> 失败订单：<?php echo $wzfsum; ?></div>
                <!--分页-->
