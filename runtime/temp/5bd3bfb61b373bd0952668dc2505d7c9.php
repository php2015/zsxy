<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:31:"./themes/admin/login/index.html";i:1571969557;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    <title>信千金后台管理系统</title>
...
<img style="width:113px;" src="../../../public/static/images/logo_w.png" /></br></br>
信千金CMS登陆
</div>
<form class="layui-form login-form" style="color:#FFF" action="<?php echo url('admin/login/login'); ?>" method="post">
