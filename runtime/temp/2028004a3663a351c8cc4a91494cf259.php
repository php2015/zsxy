<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:35:"./themes/default/chaxun/query1.html";i:1573015096;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="container">
	...
	<a class="report_btn" href="<?php echo url('/index/chaxun/yangshi1'); ?>" style="top: 2.83rem;left: 72%;">示例报告</a>
	<div class="content_box">
		<div class="content" style="margin: 1.7rem auto;">
			<div class="form_box">
				...
				<button class="pay_btn" style="background-image: linear-gradient(71deg, #6820a6 11%, #e6265c 84%), linear-gradient(#e6265c, #e6265c);">立即打赏检测</button>
				<p class="report">
