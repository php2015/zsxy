<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:33:"./themes/admin/withdraw/edit.html";i:1571815577;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/withdraw/index'); ?>">提现管理</a></li>
            <li class=""><a href="<?php echo url('admin/withdraw/add'); ?>">添加提现</a></li>
            <li class="layui-this">编辑提现</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/withdraw/update'); ?>" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">用户</label>
                        <div class="layui-input-block">
							<select name="user_id" lay-search>
								<option value="<?php echo $user_list['id']; ?>" <?php if($withdraw['user_id']==$user_list['id']): ?> selected="selected"<?php endif; ?>><?php echo $user_list['names']; ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="money" value="<?php echo $withdraw['money']; ?>" required  lay-verify="required" placeholder="请输入金额" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">类型</label>
                        <div class="layui-input-block">
                            <input type="text" name="type" value="<?php echo $withdraw['type']; ?>" required  lay-verify="required" placeholder="银行或支付宝" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">卡号</label>
                        <div class="layui-input-block">
                            <input type="text" name="bankcard" value="<?php echo $withdraw['bankcard']; ?>" required  lay-verify="required" placeholder="银行卡号或支付宝名" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
