<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:31:"./themes/admin/bjurl/index.html";i:1571815584;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">分享背景管理</li>
            <li class=""><a href="<?php echo url('admin/bjurl/add'); ?>">添加分享背景</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form layui-form-pane" action="<?php echo url('admin/bjurl/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['tname']; ?></td>
						  <td><center><img style="width:80px;" src="<?php echo $vo['thumb']; ?>"/></center></td>
                        
						<td><?php echo $vo['descc']; ?></td>
                       
                        <td>
						 	 
                            <a href="<?php echo url('admin/bjurl/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/bjurl/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
