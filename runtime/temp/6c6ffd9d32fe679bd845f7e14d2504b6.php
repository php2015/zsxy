<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./themes/dailishang/chaxun/view.html";i:1571979961;s:29:"./themes/dailishang/base.html";i:1572661643;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body" style="">
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li>查询信息</li>
            <a href="http://www.melongs.cn/index/login/view.html?dingdanids=<?php echo $dingdanid; ?>" target="_blank">
