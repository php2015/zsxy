<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./themes/dailishang/withdraw/index.html";i:1571815571;s:29:"./themes/dailishang/base.html";i:1572661643;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('dailishang/withdraw/add'); ?>">添加提现</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
			  <form class="layui-form layui-form-pane" action="<?php echo url('dailishang/withdraw/index'); ?>" method="get">
