<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"./themes/admin/banner/index.html";i:1571815585;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            ...
            <li class=""><a href="<?php echo url('admin/banner/add'); ?>">添加轮播图</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form layui-form-pane" action="<?php echo url('admin/banner/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                    <?php if(is_array($banner_list) || $banner_list instanceof \think\Collection || $banner_list instanceof \think\Paginator): if( count($banner_list)==0 ) : echo "" ;else: foreach($banner_list as $key=>$vo): ?>
                    <tr>
                        <td><?php echo $vo['id']; ?></td>
                        <td><?php echo $vo['names']; ?></td>
						<td><center><img style="height:150px;" src="<?php echo $vo['thumb']; ?>"/></center></td>
                        <td><?php echo $vo['hrefs']; ?></td>
						<td><?php echo $vo['descc']; ?></td>
                       
                        <td>
						 	 
                            <a href="<?php echo url('admin/banner/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/banner/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
