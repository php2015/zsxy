<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"./themes/admin/bjurl/edit.html";i:1571815584;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/bjurl/index'); ?>">分享背景管理</a></li>
            <li class=""><a href="<?php echo url('admin/bjurl/add'); ?>">添加分享背景</a></li>
            <li class="layui-this">编辑用户</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/bjurl/update'); ?>" method="post">
				
				
				
				<div class="layui-form-item">
                        <label class="layui-form-label">分享背景名称</label>
                        <div class="layui-input-block">
                            <input type="text" name="tname" value="<?php echo $bjurl['tname']; ?>" required lay-verify="required" placeholder="请输入分享背景名称" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">类型图标</label>
                        <div class="layui-input-block">
                            <input type="text" name="thumb" value="<?php echo $bjurl['thumb']; ?>" class="layui-input layui-input-inline" id="thumb">
					...
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="descc" value="<?php echo $bjurl['descc']; ?>" lay-verify="number" placeholder="排序" class="layui-input">
                        </div>
                    </div>
					
					<div class="layui-form-item">
                        <div class="layui-input-block">
                             <input type="hidden" name="id" value="<?php echo $bjurl['id']; ?>">
