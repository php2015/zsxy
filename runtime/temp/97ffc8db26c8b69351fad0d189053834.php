<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./themes/admin/agentgoods/edit.html";i:1571815585;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/agentgoods/update'); ?>" method="post">
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
							<select name="aid" lay-search>
                                ...
                                <option value="<?php echo $vo['id']; ?>" <?php if($agentgoods['aid']==$vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['agent_name']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
							<select name="gid" lay-search>
                                ...
                                <option value="<?php echo $vo['id']; ?>" <?php if($agentgoods['gid']==$vo['id']): ?> selected="selected"<?php endif; ?>><?php echo $vo['tname']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                   	...
                   	<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="price" value="<?php echo $agentgoods['price']; ?>" placeholder="请输入默认成本价" class="layui-input">
                        </div>
                    </div>
                  	<div class="layui-form-item">
                        <label class="layui-form-label">二级返佣</label>
                        <div class="layui-input-block">
                            <input type="text" name="erjiprice" value="<?php echo $agentgoods['erjiprice']; ?>" placeholder="请输入二级返佣" class="layui-input">
                        </div>
                    </div>
					
					<div class="layui-form-item">
                        <div class="layui-input-block">
                             <input type="hidden" name="id" value="<?php echo $agentgoods['id']; ?>">
