<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./themes/admin/insurance/index.html";i:1571815583;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form layui-form-pane" action="<?php echo url('admin/insurance/index'); ?>" method="get">
                    ...
                    <div class="layui-inline">
						...
						<div class="layui-input-inline">
						<input type="text" class="layui-input datetime" name="startTime" id="date1" value="<?php echo $startTime; ?>">
						</div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label">结束时间</label>
						<div class="layui-input-inline">
						<input type="text" class="layui-input datetime" name="endTime" id="date2" value="<?php echo $endTime; ?>">
						</div>
					</div>
                    <div class="layui-inline">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php if(isset($vo['status']) and $vo['status'] == 1): ?> <a href="<?php echo url('admin/insurance/index',['status'=>1]); ?>">成功</a><?php else: ?><a href="<?php echo url('admin/insurance/index',['status'=>2]); ?>">失败</a><?php endif; ?></td>
                        <td><?php echo date("Y-m-d H:i:s",$vo['createAt']); ?></td>
                        <td>
                            <a href="<?php echo url('admin/insurance/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                ...
                <!--分页-->
                <div style="float:right; font-size:20px;"> 今日成功人数：<?php echo $dccount; ?> | 今日失败人数：<?php echo $dscount; ?> | 总成功人数：<?php echo $ccount; ?> | 总失败人数：<?php echo $scount; ?></div>
