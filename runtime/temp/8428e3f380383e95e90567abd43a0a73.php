<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"./themes/admin/gonggao/edit.html";i:1571815583;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class=""><a href="<?php echo url('admin/gonggao/index'); ?>">公告管理</a></li>
            <li class=""><a href="<?php echo url('admin/gonggao/add'); ?>">添加公告</a></li>
            <li class="layui-this">编辑公告</li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/gonggao/update'); ?>" method="post">
				...
				<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" value="<?php echo $gonggao['title']; ?>" required lay-verify="required" placeholder="请输入公告标题" class="layui-input">
                        </div>
                    </div>
					...
					<div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="marks" value="<?php echo $gonggao['marks']; ?>" placeholder="公告内容" class="layui-input">
                        </div>
                    </div>
					<div class="layui-form-item">
                        <label class="layui-form-label">排序</label>
                        <div class="layui-input-block">
                            <input type="text" name="descc" value="<?php echo $gonggao['descc']; ?>" lay-verify="number" placeholder="排序" class="layui-input">
                        </div>
                    </div>
