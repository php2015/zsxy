<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:30:"./themes/admin/user/index.html";i:1571815578;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
               ...
               <form class="layui-form layui-form-pane" id="myform" action="<?php echo url('admin/user/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['status']==1 ? '启用' : '禁用'; ?></td>
                      	<td><a href="<?php echo url('admin/user/index',['pingfeng'=>'1']); ?>" style="color: #4b9ffa;"><?php echo $vo['pingfeng']; ?></a></td>
                        ...
                        <td>
                         	...
                         	<a href="<?php echo url('admin/user/selxia',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">查下级</a>-->   
					...
					<div style="float:right; font-size:20px;"> 今日注册数：<?php echo $countjin; ?> 其中有效人数：<?php echo $countyouxiaojin; ?>  | 人数：<?php echo $count; ?>其中有效人数：<?php echo $countyouxiao; ?></div>
                <!--分页-->
...
<script>
    function addOne(){
		$.get("<?php echo url('admin/user/form'); ?>",function(data){
			$(".form_customer:first").prepend(data);
			form.render('select');
		});
	}
	function excel(){
		 $("#myform").attr('action',"<?php echo url('admin/user/excel'); ?>");
	}
	function search(){
		 $("#myform").attr('action',"<?php echo url('admin/user/index'); ?>");
	}
</script>
