<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"./themes/admin/chaxun/view3.html";i:1572595117;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="container">
    ...
    <div class="user_card">
        ...
        <div class="user_info">
            <p>
                <img src="__PUBLIC__/bg/img/shoujihao.png" alt=""><?php if(isset($result['mobile']) and
        ...
        <div class="user_info">
            <p>
                <img class="shenfen" src="__PUBLIC__/bg/img/shenfenzheng.png" alt=""><?php if(isset($result['opcard']) and !empty($result['opcard'])): ?> <?php echo $result['opcard']; endif; ?>
            </p>
            <p>
