<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"./themes/dailishang/user/index.html";i:1571815571;s:29:"./themes/dailishang/base.html";i:1572661643;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                ...
                <form class="layui-form layui-form-pane" action="<?php echo url('dailishang/user/index'); ?>" method="get">
				<?php if($isok == '1'): ?>
					<a class="layui-btn layui-btn-normal layui-btn-radius"  href="<?php echo url('dailishang/user/indexyeji',['agentyeji'=>$agentyeji]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">业绩总览</a>
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['total_achievement']>0 ? '有效' : '无效'; ?></td>
						
                      	<td><?php echo $vo['total_achievement']; ?></td>
                        <td><?php echo date("Y-m-d H:i:s",$vo['create_time']); ?></td>
						<td> <a href="<?php echo url('dailishang/user/selxia',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">查下级</a>
						</td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
