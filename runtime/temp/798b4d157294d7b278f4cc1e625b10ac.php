<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:34:"./themes/admin/notetype/index.html";i:1571815580;s:24:"./themes/admin/base.html";i:1571969829;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body">
    ...
    <div class="layui-tab layui-tab-brief">
        <ul class="layui-tab-title">
            <li class="layui-this">文章类型管理</li>
            <li class=""><a href="<?php echo url('admin/notetype/add'); ?>">添加文章类型</a></li>
        </ul>
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">

                <form class="layui-form layui-form-pane" action="<?php echo url('admin/notetype/index'); ?>" method="get">
                ...
                <table class="layui-table">
                    ...
                    <tbody>
                    <?php if(is_array($notetype_list) || $notetype_list instanceof \think\Collection || $notetype_list instanceof \think\Paginator): if( count($notetype_list)==0 ) : echo "" ;else: foreach($notetype_list as $key=>$vo): ?>
                    <tr>
                        <td><?php echo $vo['id']; ?></td>
                        <td><?php echo $vo['tname']; ?></td>
						  <td><center><img style="height:80px; width:80px;" src="<?php echo $vo['thumb']; ?>"/></center></td>
                        
						<td><?php echo $vo['descc']; ?></td>
                       
                        <td>
						 	 
                            <a href="<?php echo url('admin/notetype/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/notetype/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
