<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"./themes/default/index/tuiguang.html";i:1571825646;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="mui-content">
			...
			<div class="mui-popup-buttons">
				...
				<span class="mui-popup-button copys" data-clipboard-action="copy" data-clipboard-target="#foo2" id="webcopy">生成链接</span>
              	<?php if($typeId == 8): ?>
					<span class="mui-popup-button"><a href="<?php echo url('index/qrc/views',array('imgid'=>$imgid,'type_status'=>$typeId)); ?>">生成二维码</a></span>
				<?php else: ?>
					<span class="mui-popup-button"><a href="<?php echo url('index/qrc/views',array('imgid'=>$imgid,'a_g_id'=>$a_g_id)); ?>">生成二维码</a></span>
				<?php endif; ?>
			</div>
			</div>
