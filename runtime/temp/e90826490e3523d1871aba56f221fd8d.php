<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"./themes/calculator/pay/hpay.html";i:1571815575;}*/ ?>
<html>
<head>
...
<div class="mui-content">
			<div class="mui-card" style="position: relative;top:0px;">
				<div class="mui-card-content">
					<form name="payform" action="<?php echo url('/calculator/pay/zfpay'); ?>" method="post" target="_blank" style="display:none;" id="czpay">
						<input type="hidden" name="price" value="<?php echo isset($_GET['price'])?$_GET['price']:$price; ?>">
						<input type="hidden" name="cid" value="<?php echo isset($_GET['cid'])?$_GET['cid']:$cid; ?>">
						<input type="hidden" name="uid" value="<?php echo isset($_GET['uid'])?$_GET['uid']:$uid; ?>">
						<input type="hidden" name="order_no" value="<?php echo isset($_GET['order_no'])?$_GET['order_no']:$order_no; ?>">
					</form>
					
					<div class="mui-card-content-inner">
						<div style="font-size: 20px;padding-bottom: 16px;padding-left: 0px;">
								<p>大数据分析优化服务费<?php echo isset($_GET['price'])?$_GET['price']+$_GET['price']:$price+$price; ?>元</p>
