<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./themes/dailishang/chaxun/estimate.html";i:1572863079;s:29:"./themes/dailishang/base.html";i:1572661643;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="layui-body" style="">
    ...
    <div class="container">
        ...
        <div class="card_box">
            ...
            <p>是否银联高端用户：<?php if(isset($result['YLZC007']) && !empty($result['YLZC007'])): ?><?php echo $result['YLZC007']; else: ?>未知<?php endif; ?></p>
